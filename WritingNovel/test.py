...
inputfile = 'C:/Users/zyhly/Documents/BookPython/chapter9/demo/data/moment.csv' #数据文件
outputfile1 = 'tmp/cm_train.xlsx' #训练样本混淆矩阵保存路径
outputfile2 = 'tmp/cm_test.xlsx' #测试样本混淆矩阵保存路径
data = pd.read_csv(inputfile, encoding = 'gbk') #读取数据，指定编码为gbk
# data = data.as_matrix() # AttributeError: 'DataFrame' object has no attribute 'as_matrix'
